(function(){
    var $module=$('<li class="dropdown"><a href class="dropdown-toggle" style="padding-top:15px; padding-bottom:0;height:54px;display:block" data-toggle="dropdown" role="button" aria-expanded="false">\
